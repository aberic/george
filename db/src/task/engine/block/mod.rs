...
///
/// record存储固定长度的数据，长度为18，即block持续长度(4字节) + block偏移量(6字节) + 链式后续数据(8字节)
/// 即block视图真实数据10+链式后续数据8，总计可存(2^64)/18条数据
#[derive(Debug, Clone)]
