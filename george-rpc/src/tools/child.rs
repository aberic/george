...
use george_db::task::traits::TForm;
use std::sync::{Arc, RwLock};

impl Children {
    pub(crate) fn indexes(view: Arc<RwLock<george_db::task::View>>) -> Vec<Index> {
    ...
    pub(crate) fn views(database: Arc<RwLock<george_db::task::Database>>) -> Vec<View> {
